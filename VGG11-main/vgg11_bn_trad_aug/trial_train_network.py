...
trainset = data_providers.CIFAR100(root='CIFAR100_Data/', set_name='train', download=False, transform=transform_train)
styled = data_providers.AugmentedCIFAR100(path='CIFAR100_Data/Pickled/',transform=transform_train)
